...
const Quiz = () => {
    ...
    const fetchQuestions = async () => {
      try {
        ...
        const response = await axios.get(
          `https://security-plus-quiz-api.vercel.app/api/quiz/questions/${encodeURIComponent(
            topic
          )}`,
          {
  ...
  return (
    <div>
      ...
      <footer className="mt-12 text-center text-gray-600 text-lg border-t border-gray-300 pt-4 bg-gray-50">
